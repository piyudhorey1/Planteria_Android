...
class ArMeasurement : AppCompatActivity(), Scene.OnUpdateListener {
...
//    }
    ...
    private val MIN_OPENGL_VERSION = 3.0
    private val TAG: String = ArMeasurement::class.java.getSimpleName()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arFragment = supportFragmentManager.findFragmentById(R.id.sceneform_fragment) as ArFragment?
        distanceModeTextView = this.findViewById(R.id.distance_view)
        multipleDistanceTableLayout = this.findViewById(R.id.multiple_distance_table)
    ...
    private fun toastMode(){
        Toast.makeText(this@ArMeasurement,
            when(distanceMode){
